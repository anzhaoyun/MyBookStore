...
class Library(models.Model):
    ...
    e_mail = models.EmailField(unique=True,blank=True,default=None,help_text='电子邮件地址')
    tel_number = models.CharField(max_length= 11,blank=True,default=None,help_text='电话号码')
    img = models.ImageField(blank=True,default=None,help_text='图片')